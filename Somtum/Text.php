...
class Text
{
    ...
    {
        return self::filter('a-zA-Z0-9@\.\-_', $text);
    }

    /**
     * ฟังก์ชั่นคืนค่าอักขระที่ต้องการตาม $patt.
     *
     * @param  $patt
     * @param  $text
     *
     * @return string
     */
    public static function filter($patt, $text)
    {
        return preg_replace('/[^'.$patt.']+/', '', $text);
    }
}
